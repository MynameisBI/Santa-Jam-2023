...
local Hakiko = Class('Hakiko', Entity)
...
function Hakiko:initialize(slot)
    ...
    self:addComponent(Sprite(Images.heroes.hakiko, 10))
    ...
    local hero = Hero('Hakiko', {'defect', 'droneMaestro'},
        {
        ...
        40, 8,
        function()
            print('Damage and stun enemies in medium range')
        end
        )
    )
