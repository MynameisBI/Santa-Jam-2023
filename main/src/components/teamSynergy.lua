...
TeamSynergy.SENTIENT_AS_THRESHOLD = {0.5, 0.8, 1.25}
...
TeamSynergy.TRAILBLAZER_DAMAGE_BONUS_THRESHOLD = {0.6, 0.9, 1.2}
TeamSynergy.DRONE_MAESTRO_DRONE_DAMAGE_THRESHOLD = {24, 40, 60} 
TeamSynergy.CRACKER_CRACK_INTERVAL_THRESHOLD = {8, 5}
