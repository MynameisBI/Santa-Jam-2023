...
function AreaSkillEntity:initialize(image, hero, x, y, range, damageInfo, secondsUntilDetonate, continuousInfo)
  ...
  self:addComponent(AreaSkill(hero, x, y, range, damageInfo, secondsUntilDetonate, continuousInfo))
end
